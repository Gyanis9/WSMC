...
class ReDataset(Dataset):
    ...
    def collate_fn(self, data):
        ...
        return idxs, label, tokens, strings, is_pre_data
...
def get_data_loader(config, data, shuffle=False, drop_last=False, batch_size=None, sampler=None):
    ...
    data_loader = DataLoader(dataset=dataset, batch_size=batch_size, shuffle=shuffle, pin_memory=True, num_workers=0,
                             sampler=sampler, collate_fn=dataset.collate_fn, drop_last=drop_last)
    return data_loader
